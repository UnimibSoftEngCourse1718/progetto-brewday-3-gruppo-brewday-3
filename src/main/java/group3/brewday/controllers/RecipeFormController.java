...
////		recipeRepository.deleteRecipeIngredient(id, ingredientId);
...
////		ingredient.setId(1l);
////		recipeRepository.addRecipeIngredient(id, ingredient);
////		return "redirect:/recipes";
////	}	
//
//
...
//		
//		model.addAttribute("recipe", recipeRepository.findOne(id));
//		return "recipeshow";
//	}
//
//}